...
public abstract class DAO<T> {
    ...
    /**
     * I am the connection used by the DAO to communicate with the database.
     */
     ...
     * @throws DAOCannotInsertException I am raised if the method cannot insert the object into the database.
     */
     ...
     * @throws DAOUpdateFailedException I am raised- if the method cannot update the object.
     */
     ...
     * @throws DAONotFoundException I am raised if the method cannot find the object.
     */
